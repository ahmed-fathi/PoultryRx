...
- API‑first design (no server-rendered HTML or Django templates).
- Stateless backend requirement.
- Frontend styling in Sass only.
- Modular, feature‑based code organization.
- Horizontal scalability considerations.
- Performance and monitoring requirements (query optimization, Redis caching,
  structured logging, Sentry, slow‑query monitoring).
- Full automated test coverage plan.
